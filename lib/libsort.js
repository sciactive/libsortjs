...
function redblacksort(arr, options, recursing) {
  var offset = 0,
      length = arr.length - offset,
      maxDelta = 0,
      // I think maxDelta here is working more like a "percentage off".
...
function oddevensort(arr, options) {
  var offset = 0,
      length = arr.length - offset,
      compareFunction = defaultCompareFunction,
      swapFunction = defaultSwapFunction,
...
var RedBlackTreeNode = exports.RedBlackTreeNode = function () {
  ...
  _createClass(RedBlackTreeNode, [{
    ...
    value: function rotateLeft() {
      var leftUncle = this.grandparent.leftChild,
          left = this.leftChild;
    ...
    value: function rotateRight() {
      var rightUncle = this.grandparent.rightChild,
